...
import 'package:contactapp/sqlite/veritabani_yardimcisi.dart';

class KisilerDaoRepository {
  Future<void> kaydet(String kisi_ad,String kisi_tel) async {
    var db = await VeritabaniYardimcisi.veritabaniErisim(); //await önce bu fonksiyonu çalıştırıp bitir. Sonra diğer satırlara geç diyor.
